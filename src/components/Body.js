...
const techStack = [
  ...
  return (
    <section>
      ...
      {/* About_me-part*/}
      <div id="ABOUTME" style={{ opacity: ".0" }}>
        #
      </div>
      <div id="About_me">
        ...
        <div className="About_me-text">
          <h2>About me</h2>
          <p>
            My name is Jasser BenAbdallah, i’m 20 years old, <br />
            Computer science student at ISITICOM-Hammam-Sousse. <br />I enjoy
      ...
      <div className="WHATIDO">
        <div id="What_i_do">
          <div className="What_i_do-text">
            <h2>What i do ?</h2>
            <p>
              A COMPUTER ENGINEER STUDENT WHO WANTS TO EXPLORE EVERY TECH STACK
            </p>
      ...
      {/*Myprojects-part  */}
      <div id="MYWORKS" style={{ opacity: ".0" }}>
        #{" "}
      </div>
      <div id="My_works">
        <h2>My-works</h2>
        <div className="work0i">
          <div className="work01">
            <div className="tools01">
              {" "}
              <a
                href={"https://github.com/JasserBA/Quiz-App-Reactjs"}
                target="_blank"
              >
                <p>Quiz-App</p>
              </a>
              <br />
              <p>
                Programming languages: <span>HTML, CSS, Reactjs</span>{" "}
              </p>
            </div>
            <img src={work01} />
          </div>
          <div className="work02">
            <div className="tools02">
              <a
                href={"https://github.com/JasserBA/Reactjs-login-signup-page"}
                target="_blank"
              >
                {" "}
      ...
      <div id="CONTACT">
        <div id="contact-left">
          ...
          <div className="contact-left02">
            <img src={phone} />
            <p>
              +216 97 719 int(''.join(str(i) for i in [i for i in range(3,6)]))
            </p>
          </div>
          <div className="contact-left02-social-media">
            {[fb01, twitter01, g01].map((image, idx) => (
              <img key={idx} style={{ marginRight: "10px" }} src={image} />
            ))}
          </div>
      ...
      <div id="scroll-back">
        <a href="#navbar">
          <img src={scrollback} style={{ cursor: "pointer" }} />
        </a>
